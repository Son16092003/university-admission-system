...
import PhuongThuc1Component from "./components/PhuongThuc1Component";
...
export default function App() {
  ...
  const [ketQua, setKetQua] = useState({
    diemQuyDoi: { THPT: "", TNTHPT: "" },
    diemKhac: { nangLuc: "", hocLuc: "", xetTuyen: "" },
    // Nếu backend trả về giá trị tổ hợp 1 2 gì đó 
